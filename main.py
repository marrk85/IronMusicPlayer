...
Copyright (c) 2021  Iron Man<https://github.com/marrk85>
...
REPO = """
» **ᴍᴜsɪᴄ ᴘʟᴀʏᴇʀ​**
» ʀᴇᴘᴏsɪᴛᴏʀʏ : [GitHub](https://github.com/marrk85/IronMusicPlayer)
» ʟɪᴄᴇɴsᴇ : AGPL-3.0-or-later

» ᴏᴡɴᴇʀ : [ ‌ٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖ𓆩🖤𓆪ــــﮩــ٨ﮩﮩ𝝙‌ٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖIRON 🖤𓆪 ‌ٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖ](telegram.me/marrk85)
"""
...
print("ᴍᴜsɪᴄ ᴘʟᴀʏᴇʀ ʙᴏᴛ sᴛᴀʀᴛᴇᴅ​!")
pytgcalls.run()
